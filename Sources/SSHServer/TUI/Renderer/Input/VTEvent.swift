...
public struct KeyEvent: Equatable, Sendable {
  ...
  internal init(character: Character? = nil, keycode: KeyCode, modifiers: KeyModifiers = [], type: KeyEventType = .press) {
  ...
  @_disfavoredOverload
  internal init(scalar: UnicodeScalar? = nil, keycode: KeyCode, modifiers: KeyModifiers = [], type: KeyEventType = .press) {
