...
public struct VTEventStream: AsyncSequence, Sendable {
  ...
  private let stream: AsyncThrowingStream<[TerminalEvent], Error>

  internal init(_ stream: AsyncThrowingStream<[TerminalEvent], Error>) {
    self.stream = stream
  }
  ...
  public struct AsyncIterator: AsyncIteratorProtocol {
    private var iterator: AsyncThrowingStream<[TerminalEvent], Error>.Iterator
    private var buffer: [TerminalEvent] = []
    private var index: Array<TerminalEvent>.Index?

    internal init(underlying: AsyncThrowingStream<[TerminalEvent], Error>.Iterator) {
